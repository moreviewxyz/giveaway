...
$url = $_ocim->get_contents('https://www.omdbapi.com/?i='.$row['imdb_id'].'&plot=full&r=json');
...
{
        $images = 'https://image.tmdb.org/t/p/w780' . $row['backdrop_path'];
} elseif ($row['poster_path']!=null){
        $images = 'https://image.tmdb.org/t/p/w780' . $row['poster_path'];
} else {
