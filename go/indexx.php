...
<script type='text/javascript' src='//pl8646931.revenuecpmnetwork.com/32/63/63/3263636232316161386339626665643036393863326138303464363163373765.js'></script>
<style>
.blink {
...
<div class="page-header text-center tittle h4">
  ...
  <a href="/register.php"> <button class="btn btn-success btn-lg"><span class="blink"><h2><font color="Chinese yellow"><strong><?php echo $daftarin_en;?></font></strong></span></button> </a>
...
<div class="btn btn-lg">
<a class="btn btn-primary btn-lg" target="_blank" href="/register.php"><i class="fa fa-comments"></i> <?php echo $komenleave_en;?></a>
