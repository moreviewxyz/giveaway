...
<div class="page-header text-center tittle h4">
  ...
  <a href="/country/gb/register.php"> <button class="btn btn-success btn-lg"><span class="blink"><h2><font color="Chinese yellow"><strong><?php echo $daftarin_en;?></font></strong></span></button> </a>
...
<div class="btn btn-lg">
<a class="btn btn-primary btn-lg" target="_blank" href="/country/gb/register.php"><i class="fa fa-comments"></i> <?php echo $komenleave_en;?></a>
    ...
    <div class="col-md-3 col-xs-12">
      <div class="text-center h3" style="margin-top: 0;font-size: 18px;"><?php echo $liane_en;?></div>
                    <div class="col-md-12">
                <a href="/country/gb/register.php" title="€ 90,000" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $fulus_en;?></span>
                            ...
                            <div class="col-md-12">
                <a href="/country/gb/register.php" title="2000 kg de oro" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $emas_en;?></span>
                            ...
                            <div class="col-md-12">
                <a href="/country/gb/register.php" title="Coche de lujo" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $embem_en;?></span>
                            ...
                            <div class="col-md-12">
                <a href="/country/gb/register.php" title="Apartamentos de lujo" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $imah_en;?></span>
                            ...
                            <div class="col-md-12">
                <a href="/country/gb/register.php" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $ipon_en;?></span>
                            ...
                            <div class="col-md-12">
                <a href="/country/gb/register.php" title="Samsung Galaxy Fold" class="text-center">
