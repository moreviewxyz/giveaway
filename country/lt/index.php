...
include_once($_SERVER['DOCUMENT_ROOT'] ."/language/lt.php");
?>
<!DOCTYPE HTML>
...
<head>
  ...
  <title><?php echo $config_artis;?> - <?php echo $janjiartis_lt;?></title>
...
<div class="navbar navbar-inverse navbar-static-top">
        <div class="container">
                <div class="navbar-header">
                       ...
                       <a class="navbar-brand" href="#"><?php echo $header_lt;?></a>
                </div><!-- navbar-header -->
...
<div class="container box-container">
  ...
  <center>
    <div class="text-center media-heading" style="margin-top: 10px;">
      <h1><font color="green"><strong><span class="blink"><?php echo $selamet_lt;?></span></strong></font></h1>
      <br><br>
      <h2><font color="red"><strong><?php echo $menangkeun_lt;?></font><span class="blink"><font color="green"> <b><?php echo $config_artis;?></b></font></span></strong></h2>
      <br>
  </center>
  <center>
    <div class="available-formats-img-mobile"><img src="/include/images/gambar1.png" class="img-responsive"> </div>
  
      <h3><font color="black"><strong><font color="orange"><?php echo $ucapan_lt;?> <span class="blink"><b><font color="red"><?php echo $jenisduit_lt;?><?php echo $config_duite;?> - <?php echo $jenisduit_lt;?><?php echo $config_duite1;?></font></b></span> <?php echo $ucapan1_lt;?></font> </strong></h3>
      <br>
    <div class="available-formats-img-mobile"><img src="/include/images/pisa.png" class="img-responsive"></div>
      <h3><font color="Black bean"><strong> <?php echo $ucapan2_lt;?></strong></font> </h3><br>
  </center>
...
<div class="page-header text-center tittle h4">
              ...
              <div style="text-align:center">
                ...
                <center>
                  <div>
                    <span style="font-size: 15px; text-align: center; color: #08088A; font-style: italic;"><?php echo $mungguhmu_lt;?></span>
                    <br>
                    <span style="font-size: 15px; text-align: center; color: #B40431;">~ Michele Johnson ~</span>
                  </div>
                </center>
          <center>  
  <h3><font color="green"><strong><span class="blink"> <?php echo $ucapan3_lt;?></span></strong></font> </h3><br>
  <h2><b><font color="E01A1A"><?php echo $ngenteni_lt;?></font></b></h2>
  ...
  <a href="/register.php"> <button class="btn btn-success btn-lg"><span class="blink"><h2><font color="Chinese yellow"><strong><?php echo $daftarin_lt;?></font></strong></span></button> </a>
  </div><p><i class="fa fa-lock"></i> <?php echo $amanin_lt;?></p>
  </center>
  ...
  <tr>
    <div class="col-md-12">
      <div id="fbFeedbackContent">
        <p align="left">
          <font color="#4169E1"><strong><?php echo $komenjum_lt;?> </strong></font> 
        </p> 
        <td>
          <div class="activityContent">
            <div class='fb_comment_wrapper'>
              ...
              <div class='fb_meta'>
                <a onclick="JavaScript:alert('You must create an account before commenting.')" class='fb_like fb_meta_item'><?php echo $suka_lt;?></a> •
                <a onclick="JavaScript:alert('You must create an account before commenting.')" class='fb_like fb_meta_item'><?php echo $balasan_lt;?></a> •
                ...
                <span class='fb_timestamp'>
                  <div class='fb_image_block'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>5 <?php echo $waktumenit_lt;?>
                </span>
              </div>
            </div>
            ...
            <div class='fb_comment_wrapper'>
              ...
              <div class='fb_comment_block'>
                ...
                <div class='fb_meta'>
                  ...
                  <span class='fb_timestamp'>7 <?php echo $waktumenit_lt;?></span>
                </div>
            </div>
            ...
            <div class='fb_comment_wrapper'>
              ...
              <div class='fb_meta'>
                ...
                <span class='fb_timestamp'>
                  <div class='fb_image_block'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>1 <?php echo $waktujam_lt;?>
                </span>
              </div>
            </div>
            ...
            <div class='fb_comment_wrapper'>
              ...
              <div class='fb_comment_block'>
                ...
                <div class='fb_comment'>
                  ...
                  <span class='fb_timestamp'>1 <?php echo $waktujam_lt;?></span>
                  </div>
              </div>
            ...
            <div class='fb_comment_wrapper'>
              <div class='fb_image_block'><img src='https://bit.ly/3p69ucw' class='fb_pic'/></div>
                <div class='fb_comment_block'>
                  ...
                  <div class='fb_meta'>
                    ...
                    <span class='fb_timestamp'>2 <?php echo $waktujam_lt;?></span>
                  </div>
                </div>
              </div>
              ...
              <div class='fb_comment_wrapper'>
                ...
                <div class='fb_comment_block'>
                  ...
                  <div class='fb_comment'><?php echo $komen8_lt;?>
                ...
                <div class='fb_meta'>
                  ...
                  <span class='fb_timestamp'>
                    <div class='fb_image_block'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>3 <?php echo $waktujam_lt;?>
                  </span>
                </div>
              </div>
              ...
              <div class='fb_comment_wrapper'>
                ...
                <div class='fb_meta'>
                  ...
                  <span class='fb_timestamp'>
                    <div class='fb_image_block'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>4 <?php echo $waktujam_lt;?>
                  </span>
                </div>
              </div>
              ...
              <div class='fb_comment_wrapper'>
                ...
                <div class='fb_comment_block'>
                  ...
                  <div class='fb_meta'>
                    ...
                    <span class='fb_timestamp'>4 <?php echo $waktujam_lt;?></span>
                  </div>
                </div>
              </div>
              ...
              <div class='fb_comment_wrapper'>
                ...
                <div class='fb_meta'>
                  ...
                  <span class='fb_timestamp'>
                    <div class='fb_image_block'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>5 <?php echo $waktujam_lt;?>
                  </span>
                </div>
              </div>
              </div>
              ...
              <br/> 
              <br/> 
              <div class="col-sm-6"><a onclick="JavaScript:alert('You must register an account before commenting..')"><?php echo $komenmore_lt;?></a></div>
              <div class="pull-right"><p><?php echo $komenangka_lt;?></p></div>
              <hr class="fb_line">
              <div class="fb_plugin">
                <img src="/include/images/fav.png" class="fb_icon">
                <a href="#" class="fb_plugin_link"><?php echo $fbplugin_lt;?></a>
              </div>
            </td>
          </tr>
        </tbody>
...
<div class="btn btn-lg">
<a class="btn btn-primary btn-lg" target="_blank" href="/register.php"><i class="fa fa-comments"></i> <?php echo $komenleave_lt;?></a>
    ...
    <div class="col-md-3 col-xs-12">
      <div class="text-center h3" style="margin-top: 0;font-size: 18px;"><?php echo $liane_lt;?></div>
                    <div class="col-md-12">
                <a href="/register.php" title="€ 90,000" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $fulus_lt;?></span>
                </a>
              </div>
                            <div class="col-md-12">
                <a href="/register.php" title="2000 kg de oro" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $emas_lt;?></span>
                </a>
              </div>
                            <div class="col-md-12">
                <a href="/register.php" title="Coche de lujo" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $embem_lt;?></span>
                </a>
              </div>
                            <div class="col-md-12">
                <a href="/register.php" title="Apartamentos de lujo" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $imah_lt;?></span>
                </a>
              </div>
                            <div class="col-md-12">
                <a href="/register.php" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $ipon_lt;?></span>
                </a>
              </div>
                            <div class="col-md-12">
                <a href="/register.php" title="Samsung Galaxy Fold" class="text-center">
                  ...
                  <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $samsung_lt;?></span>
                </a>
              </div>
                  </div>
  </div>
...
<footer class="col-md-12" style="background:#b37700;padding: 20px;color: white;font-weight: bolder;text-shadow: 0px  0px 1px rgb(0, 0, 0);">
  <div class="container">
    <div class="col-sm-6"><?php echo $footer_lt;?></div>
    <div class="col-sm-6">
      <button class="btn btn-default btn-sm pull-right" data-toggle="modal" data-target=".contact" style="Minute-width: 100px;"><?php echo $kontakaja_lt;?></button>
    </div>
  </div>
</footer>
    ...
    <script type="text/javascript">
      $ (document).ready(function(){
        ...
        function newActivity() {
          ...
          var comm = ['<?php echo $acak1_lt;?>','<?php echo $acak2_lt;?>','<?php echo $acak3_lt;?>','<?php echo $acak4_lt;?>',
                      '<?php echo $acak5_lt;?>','<?php echo $acak6_lt;?>','<?php echo $acak7_lt;?>','<?php echo $acak8_lt;?>',
                      '<?php echo $acak9_lt;?>','<?php echo $acak10_lt;?>','<?php echo $acak11_lt;?>','<?php echo $acak12_lt;?>',
                      '<?php echo $acak13_lt;?> ','<?php echo $acak14_lt;?>'];
        ...
        +comms+'<img src="'+pics+
        '" class="img-responsive img_comment"></div></div><div class="fb_meta"><a onclick="JavaScript:alert("You must create an account before commenting."")" class="fb_like fb_meta_item"><?php echo $suka_lt;?></a> •<a onclick="JavaScript:alert("You must create an account before commenting.")" class="fb_like fb_meta_item"><?php echo $balasan_lt;?></a> •<img class="fb_like_button fb_meta_item" src="/include/images/like.png"><span class="like_count fb_meta_item">20</span> •<span class="fb_timestamp"><div class="fb_image_block">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><?php echo $acak15_lt;?></span></div></div>').fadeIn();
        }
      });
  ...
  <div class="modal-dialog">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title text-center"><?php echo $kontakaja_lt;?> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button></h3>
      </div>
      <div class="panel-body">
       
        <form action="" method="POST" role="form" enctype="multipart/form-data">
          <div class="form-group">
            <label for=""><?php echo $kontaknama_lt;?></label>
            <input name="name" required="" type="text" class="form-control" id="name" placeholder="<?php echo $kontaknama1_lt;?>">
          </div>
          <div class="form-group">
            <label for=""><?php echo $kontakmail_lt;?></label>
            <input name="email" required="" type="email" class="form-control" id="email" placeholder="<?php echo $kontakmail1_lt;?>">
          </div>
          <div class="form-group">
            <label for=""><?php echo $kontakpesan_lt;?></label>
            <textarea name="message" required="" class="form-control" id="message" placeholder="<?php echo $kontakpesan1_lt;?>" style="resize: none;"></textarea>
          </div>
                                                <input type="hidden" name="contact" value="submit">
            <button id="submitcontact" type="submit" class="btn btn-primary pull-right"><?php echo $kontaktekan_lt;?></button>
        </form>
